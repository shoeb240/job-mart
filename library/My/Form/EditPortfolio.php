<?php
class My_Form_EditPortfolio extends Zend_Form
{
    public function init()
    {
        $this->setMethod('post')
             ->setAction('/account/edit-portfolio')
        ...
        $portfolioImage->addDecorators(array('PortfolioEditImage'));
        
        $portfolioId = $this->createElement('hidden', 'portfolio_id');
        
        $this->addElements(array($portfolioTitle, $clientName, $projectUrl, $projectDescription, $portfolioImage, $portfolioId));
